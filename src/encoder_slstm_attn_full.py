...
class LSTMTrainer(Trainer):
    def __init__(self, encoder, lstm, config, device, device_one, wandb=None, trial="", crossv="", gtrial=""):
    ...
    def generate_batch(self, episodes, mode):
        ...
        for indices in sampler:
            ...
            yield torch.stack(sx).to(self.device_one), ts_number.to(self.device_one)
