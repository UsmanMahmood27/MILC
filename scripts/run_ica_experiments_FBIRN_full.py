...
from src.encoders_full import NatureCNN, ImpalaCNN
...
from src.slstm_attn_full import LSTMTrainer
...
def train_encoder(args):
    ...
    # For ICA TC Data
    fix_z=22
#    data = np.zeros((subjects, sample_x, sample_y, sample_z, tc))
...
#    with open('../fMRI/FBIRN/fMRI_complete_FBIRN.npz', 'wb') as filesim:
