...
def train_encoder(args):
    ...
    for p in range(subjects):
        ...
        d = df.values
        data[p, :, :] = d[:, 0:tc]
    # t = np.random.permutation(data.shape[0])
    ...
    for i in range(subjects):
        for j in range(samples_per_subject):
            ...
            finalData[i, j, :, :] = data[i, :, (j * sample_y):(j * sample_y) + sample_y]
    ...
    if args.encoder_type == "Nature":
        ...
        # model_dict = torch.load('/Users/umahmood1/Documents/ST_DIM/baselines/pytorch-a2c-ppo-acktr-gail/STDIM_fMRI/scripts/wandb//run-2019-09-0921:37:48/encoder.pt',map_location=torch.device('cpu')) # with good components
        model_dict = torch.load('/Users/umahmood1/Documents/ST_DIM/baselines/pytorch-a2c-ppo-acktr-gail/STDIM_fMRI/scripts/wandb//run-2019-09-1019:14:06/encoder.pt',map_location=torch.device('cpu')) # with good components
