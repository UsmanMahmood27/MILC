...
def train_encoder(args):
    ...
    # For ICA TC Data
    data = np.zeros((569, 100, 140))
    # modifieddata = np.zeros((823, 100, 1100))
    finalData = np.zeros((569, 13, 100, 20))
    finalData2 = np.zeros((569, 13, 53, 20))
    ...
    data2 = data2.reshape(569, 100, 140)
    data = data2
    ...
    index_array = index_array.view(569)
    ...
    tr_index2 = index_array[test_indexe:569]
